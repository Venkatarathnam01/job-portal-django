...
from recruiter_app.views import recruiter_signup,recruiter_login,recruiter_dashboard,recruiter_profile,recruiter_logout,recruiter_profile_update,job_details,applied_job,approve,homepage
...
urlpatterns = [
    ...
    path("job_detail/",job_details,name="job_details"),
    ...
    path("result/",scheduled,name="scheduled")
]
# 6.....
if settings.DEBUG:
